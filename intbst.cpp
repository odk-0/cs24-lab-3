...
// recurrsive helper for destructor
...
// recurrsive helper for insert (assumes n is never 0)
...
// recurrsive helper for printPreOrder()
...
// Node* n: the node to start with (for a recurrsive call)
...
bool IntBST::remove(int value){
    ...
    if(curr->left && curr->right){
        Node* pred = getPredecessorNode(curr->info);
        curr->info = pred->info;
        curr=pred;
    }
